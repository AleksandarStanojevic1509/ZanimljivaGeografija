...
// let botTotalPoints = 0;
    ...
    for (let i = 0; i<= category.length; i++){
       ...
       checkIfItIsTrue(isBotExist, isUserExist, botAnswers[i], playerAnswers[i], resultTable.children[i].children[1], resultTable.children[i].children[2], resultTable.children[i].children[3], resultTable.children[i].children[4])
