...
export const renderHelp = () =>{
    ...
    <div id="help-box">
            <div>
                ...
                <p>&nbsp;&nbsp;&nbsp;* Takođe, ako želite možete učestvovati u popunjavanju baze. Termine možete predložiti klikom na <i style="border: 1px solid #26a69a;display: inline-flex;width: 30px;color: #26a69a;" class="material-icons"class="material-icons" > cloud_upload</i> ikonicu.</p>
